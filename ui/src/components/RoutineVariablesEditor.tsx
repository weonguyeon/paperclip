  ...
  return (
    <Collapsible open={open} onOpenChange={setOpen}>
      <CollapsibleTrigger className="flex w-full items-center justify-between rounded-lg border border-border/70 px-3 py-2 text-left">
        <div>
          <p className="text-sm font-medium">변수</p>
          <p className="text-xs text-muted-foreground">
            루틴 제목 및 지시사항의 `{"{{name}}"}` 플레이스홀더에서 감지됨.
          </p>
        </div>
              ...
              <div className="space-y-1.5 md:col-span-2">
                ...
                {variable.type === "textarea" ? (
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="__unset__">기본값 없음</SelectItem>
                  ...
                  <div className="grid gap-3 md:grid-cols-2">
                    ...
                    <div className="space-y-1.5">
                      <Label className="text-xs">기본 옵션</Label>
                      <Select
                      ...
                      >
                        <SelectTrigger>
                          <SelectValue placeholder="기본값 없음" />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectItem value="__unset__">기본값 없음</SelectItem>
                  ...
                  <Input
                    ...
                    placeholder={variable.type === "number" ? "42" : "기본값"}
                  />
                )}
              </div>
            </div>
...
export function RoutineVariablesHint() {
  return (
    <div className="rounded-lg border border-dashed border-border/70 px-3 py-2 text-xs text-muted-foreground">
      지시사항에 `{"{{variable_name}}"}` 플레이스홀더를 사용하면 루틴 실행 시 입력값을 요청합니다.
    </div>
  );
}
